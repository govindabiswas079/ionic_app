...
import { Box, Slide, Grow, Container, Typography, FormControl, InputLabel, OutlinedInput, TextField, MenuItem, Button, FormHelperText, styled } from '@mui/material';
...
const AdVertiseFrom = ({ showSub, vendorCatList, storeinfo, vendorCatListLoader, showSubPaln }) => {
  ...
  var config_AdVertise = {
    method: 'post',
    url: sanitizeUrl(`${ApiRequestUrl.baseUrl}/createAdvertise`),
    headers: {
  ...
  const maxDate = new Date(new Date().getFullYear(), new Date().getMonth() + 1, 10);
            ...
            <div>
              <Box sx={{ pt: 10 }}>
                <Container>
                  ...
                  <Typography sx={{ color: '#000000', fontFamily: 'Nunito', fontWeight: '700', fontSize: 20 }}>New Advertise</Typography>
                </Container>
                        ...
                        <div>
                          <Box>
                            <Container sx={{ pb: 3 }}>
                              ...
                              <Box sx={{ pt: 2 }}>
                                <FormControl fullWidth error={categoryId} sx={{ ...theme.typography.customInput }}>
                              ...
                              <Box sx={{ pt: 2 }}>
                                <FormControl fullWidth error={adDescription} sx={{ ...theme.typography.customInput }}>
                              ...
                              <Box sx={{ pt: 2 }}>
                                <FormControl fullWidth error={rowMatter} sx={{ ...theme.typography.customInput }}>
